import{i as R,u as Z,f as Y,h as G,k,n as J,R as K,D as Q}from"./directive-helpers-CUT2Nyqc.js";var L="";function E(t){L=t}function W(t=""){if(!L){const e=[...document.getElementsByTagName("script")],r=e.find(i=>i.hasAttribute("data-shoelace"));if(r)E(r.getAttribute("data-shoelace"));else{const i=e.find(s=>/shoelace(\.min)?\.js($|\?)/.test(s.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(s.src));let o="";i&&(o=i.getAttribute("src")),E(o.split("/").slice(0,-1).join("/"))}}return L.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var T=Object.defineProperty,X=Object.defineProperties,ee=Object.getOwnPropertyDescriptor,te=Object.getOwnPropertyDescriptors,A=Object.getOwnPropertySymbols,re=Object.prototype.hasOwnProperty,se=Object.prototype.propertyIsEnumerable,z=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),B=(t,e,r)=>e in t?T(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,V=(t,e)=>{for(var r in e||(e={}))re.call(e,r)&&B(t,r,e[r]);if(A)for(var r of A(e))se.call(e,r)&&B(t,r,e[r]);return t},Se=(t,e)=>X(t,te(e)),h=(t,e,r,i)=>{for(var o=i>1?void 0:i?ee(e,r):e,s=t.length-1,a;s>=0;s--)(a=t[s])&&(o=(i?a(e,r,o):a(o))||o);return i&&o&&T(e,r,o),o},ie=function(t,e){this[0]=t,this[1]=e},Ee=t=>{var e=t[z("asyncIterator")],r=!1,i,o={};return e==null?(e=t[z("iterator")](),i=s=>o[s]=a=>e[s](a)):(e=e.call(t),i=s=>o[s]=a=>{if(r){if(r=!1,s==="throw")throw a;return a}return r=!0,{done:!1,value:new ie(new Promise(l=>{var n=e[s](a);if(!(n instanceof Object))throw TypeError("Object expected");l(n)}),1)}}),o[z("iterator")]=()=>o,i("next"),"throw"in e?i("throw"):o.throw=s=>{throw s},"return"in e&&i("return"),o},oe={name:"default",resolver:t=>W(`assets/icons/${t}.svg`)},ae=oe,O={caret:`
  ...
  `},le={name:"system",resolver:t=>t in O?`data:image/svg+xml,${encodeURIComponent(O[t])}`:""},ne=le,y=[ae,ne],x=[];function ce(t){x.push(t)}function he(t){x=x.filter(e=>e!==t)}function j(t){return y.find(e=>e.name===t)}function de(t,e){ue(t),y.push({name:t,resolver:e.resolver,mutator:e.mutator,spriteSheet:e.spriteSheet}),x.forEach(r=>{r.library===t&&r.setIcon()})}function ue(t){y=y.filter(e=>e.name!==t)}var ve=R`
  :host {
...
`;function H(t,e){const r=V({waitUntilFirstUpdate:!1},e);return(i,o)=>{const{update:s}=i,a=Array.isArray(t)?t:[t];i.update=function(l){a.forEach(n=>{const c=n;if(l.has(c)){const w=l.get(c),p=this[c];w!==p&&(!r.waitUntilFirstUpdate||this.hasUpdated)&&this[o](w,p)}}),s.call(this,l)}}}var ge=R`
  :host {
 ...
 */const Pe=t=>t??Q,M=new Set,g=new Map;let u,$="ltr",S="en";const D=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(D){const t=new MutationObserver(q);$=document.documentElement.dir||"ltr",S=document.documentElement.lang||navigator.language,t.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function N(...t){t.map(e=>{const r=e.$code.toLowerCase();g.has(r)?g.set(r,Object.assign(Object.assign({},g.get(r)),e)):g.set(r,e),u||(u=e)}),q()}function q(){D&&($=document.documentElement.dir||"ltr",S=document.documentElement.lang||navigator.language),[...M.keys()].map(t=>{typeof t.requestUpdate=="function"&&t.requestUpdate()})}let _e=class{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){M.add(this.host)}hostDisconnected(){M.delete(this.host)}dir(){return`${this.host.dir||$}`.toLowerCase()}lang(){return`${this.host.lang||S}`.toLowerCase()}getTranslationData(e){var r,i;const o=new Intl.Locale(e.replace(/_/g,"-")),s=o==null?void 0:o.language.toLowerCase(),a=(i=(r=o==null?void 0:o.region)===null||r===void 0?void 0:r.toLowerCase())!==null&&i!==void 0?i:"",l=g.get(`${s}-${a}`),n=g.get(s);return{locale:o,language:s,region:a,primary:l,secondary:n}}exists(e,r){var i;const{primary:o,secondary:s}=this.getTranslationData((i=r.lang)!==null&&i!==void 0?i:this.lang());return r=Object.assign({includeFallback:!1},r),!!(o&&o[e]||s&&s[e]||r.includeFallback&&u&&u[e])}term(e,...r){const{primary:i,secondary:o}=this.getTranslationData(this.lang());let s;if(i&&i[e])s=i[e];else if(o&&o[e])s=o[e];else if(u&&u[e])s=u[e];else return console.error(`No translation found for: ${String(e)}`),String(e);return typeof s=="function"?s(...r):s}date(e,r){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),r).format(e)}number(e,r){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(this.lang(),r).format(e)}relativeTime(e,r,i){return new Intl.RelativeTimeFormat(this.lang(),i).format(e,r)}};var F={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format"};N(F);var Le=F,Re=class extends _e{};N(Le);const I={list:`
  ...
  `},Me=t=>t in I?`data:image/svg+xml,${encodeURIComponent(I[t])}`:"";function ke(){de("bundled",{resolver:Me})}export{Re as L,Be as R,d as S,h as _,fe as a,m as b,ge as c,Oe as d,Ae as e,Se as f,V as g,me as h,ye as i,xe as j,je as k,be as l,Ee as m,v as n,ke as r,Pe as t,H as w};
